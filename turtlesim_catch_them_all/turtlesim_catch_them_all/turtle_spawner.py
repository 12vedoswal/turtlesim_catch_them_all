...
from my_robot_interfaces.srv import CatchTurtles
...
class TurtleSpawnerNode(Node):
    def __init__(self):
        ...
        self.catch_turtle_service_ = self.create_service(
            CatchTurtles, "catch_turtle", self.callback_catch_turtle)
        self.spawn_turtle_timer_ = self.create_timer(
            1.0/self.spawn_frequency_, self.spawn_new_turtle)

    def callback_catch_turtle(self, request: CatchTurtles.Request, response: CatchTurtles.Response):
